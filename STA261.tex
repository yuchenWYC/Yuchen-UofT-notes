...
\paragraph{E\&R theorem 4.6.2}
 ...
 \paragraph{Note}
 If $T_n \overset{a.s.}{\theta}$ then $T_n$ is called consistent (almost surely). In this course we will only talk about consistent (in probability)
 ...
 \paragraph{Note}
 MSE consistent $\implies$ consistent (in probability)
