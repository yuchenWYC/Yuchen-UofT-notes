...
\begin{align*}
	...
	&= -\left( \underset{z \sim q_\phi}{\mb{E}} \left[ \log q_\phi (z|x)\right] + \underset{z \sim q_\phi}{\mb{E}} \left[p(z,x)\right] \right) + \underset{z \sim q_\phi}{\mb{E}} \left[ \log p(x) \right]\\
